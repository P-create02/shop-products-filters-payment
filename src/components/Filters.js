      ...
      <form onSubmit={(e) =>{e.preventDefault()}}>
        ...
        <div className="form-control">
          ...
          <div className="colors">
            {colors.map((c, index) =>{
              if(c === 'all'){
                return <button key={index} name='color' data-color='all' onClick={updateFilters}
                className={`all-btn ${color === 'all' && 'active'}`}>all</button>
              }
              return <button key={index} name='color' style={{background: c}} 
                className={`color-btn ${color === c && 'acitve'}`}
